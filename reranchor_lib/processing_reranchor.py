...
class ReranchorProcessor(BaseVisualRetrieverProcessor, Qwen2VLProcessor):  # noqa: N801
    """
    ...
    """
    query_symbol: ClassVar[str] = "<query>"
    visual_prompt_prefix: ClassVar[str] = (
        f"<|im_start|>system\nyou are a smart assistant that helps users find relevant regions in the given image based on the provided question.<|im_end|>\n<|im_start|>user\n{query_symbol}<|vision_start|><|image_pad|><|vision_end|><|im_end|>\n<|im_start|>assistant"
    )
    ...
    def process_texts_and_images(
        ...
        """
        texts = [self.visual_prompt_prefix.replace(self.query_symbol, q.strip()) for q in texts]
